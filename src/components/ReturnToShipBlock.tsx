  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-3 text-slate-700 leading-relaxed">
        {note ??
          "Build at least 45–60 minutes between your excursion's stated return and your ship's all-aboard time. I-93 traffic, harbour-area congestion, and summer crowds downtown can add unexpected delay."}
      </p>
